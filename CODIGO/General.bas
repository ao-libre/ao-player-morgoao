...
'***************************************************
    ...
    If LegalOk And Not UserParalizado Then
        ...
        If Not UserDescansar And Not UserMeditar Then
            ...
            Call Recorder.addMove(Direccion)
        End If
    Else
...
'*****************************************************************
    ...
    If UserMoving = 0 Then
        ...
        End If
    End If
        'Call addBuffer(, eChannel.Outgoing)
End Sub
...
#End If
   ...
   'Init timers
    ...
    Call Recorder.Initialize(frmMain)
    'Call Recorder.startRecording(lastChar, frmMain.RecTxt, UserMap, UserCharIndex)
    frmMain.Picture = LoadPicture(DirGraficos & "VentanaPrincipal.JPG")
...
Public Function getWeaponByGrhIndex(ByVal GrhIndex As Integer, ByVal Heading As Byte) As Integer
Dim i As Integer
If GrhIndex = 0 Then
    getWeaponByGrhIndex = 2
    Exit Function
End If
For i = LBound(WeaponAnimData) To UBound(WeaponAnimData)
    If WeaponAnimData(i).WeaponWalk(Heading).GrhIndex = GrhIndex Then
        getWeaponByGrhIndex = i
        Exit Function
    End If
Next i
getWeaponByGrhIndex = 2 'no anim (despues go constante)
End Function
Public Function getCascoByGrhIndex(ByVal GrhIndex As Integer, ByVal Heading As Byte) As Integer
Dim i As Integer
If GrhIndex = 0 Then
    getCascoByGrhIndex = 2
    Exit Function
End If
For i = LBound(CascoAnimData) To UBound(CascoAnimData)
    If CascoAnimData(i).Head(Heading).GrhIndex = GrhIndex Then
        getCascoByGrhIndex = i
        Exit Function
    End If
Next i
getCascoByGrhIndex = 2 'no anim (despues go constante)
End Function
Public Function getShieldByGrhIndex(ByVal GrhIndex As Integer, ByVal Heading As Byte) As Integer
Dim i As Integer
If GrhIndex = 0 Then
    getShieldByGrhIndex = 2
    Exit Function
End If
For i = LBound(ShieldAnimData) To UBound(ShieldAnimData)
    If ShieldAnimData(i).ShieldWalk(Heading).GrhIndex = GrhIndex Then
        getShieldByGrhIndex = i
        Exit Function
    End If
Next i
getShieldByGrhIndex = 2 'no anim (despues go constante)
End Function
