...
On Error GoTo ErrorHandler
    ...
    While Not EOF(handle)
        Get handle, , Grh
        If Grh > 0 And Grh <= grhCount Then
                With GrhData(Grh)
...
'***************************************************
    ...
    If EngineRun Then
        ...
        Call RenderCursor(258 + MouseViewX, 259 + MouseViewY)
        
        If charlist(UserCharIndex).Head.Head(3).GrhIndex > 0 Then
            Call DDrawTransGrhtoSurface(charlist(UserCharIndex).Head.Head(3), 241 + MouseViewX, 236 + MouseViewY, 1, 1)
        End If
...
Public Sub RenderCursor(ByVal X As Long, ByVal Y As Long)
BackBufferSurface.DrawCircle X, Y, 15
End Sub
