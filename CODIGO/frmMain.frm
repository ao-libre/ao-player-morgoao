...
Public Sub ActivarMacroHechizos()
    ...
    Call Recorder.addControlSM(eSMType.mSpells, True)
End Sub
...
Public Sub DesactivarMacroHechizos()
    ...
    Call Recorder.addControlSM(eSMType.mSpells, False)
End Sub
...
Public Sub ActivarMacroTrabajo()
    ...
    Call Recorder.addControlSM(eSMType.mWork, True)
End Sub
...
Public Sub DesactivarMacroTrabajo()
    ...
    Call Recorder.addControlSM(eSMType.mWork, False)
End Sub
...
#End If
    ...
    'If InStr(RD, "Pato") Then Stop
    'Call Recorder.addDataPacket(eChannel.Incoming, RD)
    'If InStr(RD, "Pato") Then Stop
