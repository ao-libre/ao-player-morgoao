        ...
        Select Case Comando
            ...
            Case "/VIDEO"
                If Not Recorder.isRecording Then
                    If Recorder.startRecording(lastChar, frmMain.RecTxt.TextRTF, UserMap, UserCharIndex) Then
                        Call ShowConsoleMsg("Grabando video!", 0, 192, 128, True)
                    End If
                Else
                    Call Recorder.stopRecording
                    Call ShowConsoleMsg("Has dejado de grabar", 0, 192, 128, True)
                End If
